...
OBJ_FILES = ${C_SOURCES:.c=.o cpu/isr_keyboard.o cpu/kernel_entry.o cpu/gdt.o cpu/exception_isr.o cpu/isr_pit.o cpu/switch_task.o cpu/syscall_isr.o cpu/user_test.o}
DISK_IMG = disk.img
